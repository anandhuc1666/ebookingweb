    ...
    <div>
      <div className="Navbar">
        ...
        <ul style={{ display: 'flex', listStyle: 'none', marginLeft: '40%', }}>
          ...
          <Link to={'/About'} style={{ textDecoration: "none" }}><li className='nav-li'>About</li></Link>
        ...
        <div className="box-cart-favo">
          ...
          <Link to={'/Fav'}><img src="https://cdn-icons-png.flaticon.com/512/833/833472.png" alt="favorite" className="icon-favorite" style={{ filter: 'brightness(0) saturate(100%) invert(0)' }} /></Link>
